<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/bed/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary">
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/bed/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'bed' } }"
...
export default {
  name: 'app-bed-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'bed/list/hasRows',
      loading: 'bed/list/loading',
      exportLoading: 'bed/list/exportLoading',
      selectedRows: 'bed/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new BedPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new BedPermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'bed/list/doExport',
      doRemoveAllSelected:
        'bed/list/doRemoveAllSelected',
      doDisableAllSelected:
        'bed/list/doDisableAllSelected',
      doEnableAllSelected:
        'bed/list/doEnableAllSelected',
      doDestroyAll: 'bed/destroy/doDestroyAll',
    }),
