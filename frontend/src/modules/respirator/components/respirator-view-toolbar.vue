<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: `/respirator/${record.id}/edit` }" v-if="record && hasPermissionToEdit">
...
export default {
  name: 'app-respirator-view-toolbar',
  ...
  computed: {
    ...
    hasPermissionToImport() {
      return new RespiratorPermissions(this.currentUser).import;
    },
