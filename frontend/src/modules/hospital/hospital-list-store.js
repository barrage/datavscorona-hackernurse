...
import hospitalListExporterFields from '@/modules/hospital/hospital-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!hospitalListExporterFields || !hospitalListExporterFields.length) {
          throw new Error('hospitalListExporterFields is required');
        }
