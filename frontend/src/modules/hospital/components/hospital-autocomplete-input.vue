...
<script>
import HospitalFormModal from '@/modules/hospital/components/hospital-form-modal';
import { HospitalPermissions } from '@/modules/hospital/hospital-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-hospital-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [HospitalFormModal.name]: HospitalFormModal,
  },
  ...
  computed: {
    ...
    hasPermissionToCreate() {
      return new HospitalPermissions(this.currentUser)
        .create;
    },
  },
