<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: `/hospital/${record.id}/edit` }" v-if="record && hasPermissionToEdit">
...
export default {
  name: 'app-hospital-view-toolbar',
  ...
  computed: {
    ...
    hasPermissionToImport() {
      return new HospitalPermissions(this.currentUser).import;
    },
